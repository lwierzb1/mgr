...
from colorization_program.src.gui.config_picker import ConfigPicker
from colorization_program.src.gui.display_canvas import DisplayCanvas
from colorization_program.src.gui.drawing_canvas import DrawingCanvas
from colorization_program.src.gui.styled_observer_button import StyledObserverButton
from colorization_program.src.gui.video_display_canvas import VideoDisplayCanvas
from colorization_program.src.gui.video_drawing_canvas import VideoDrawingCanvas
from colorization_program.src.toolkit.gui import create_info_confirm_window
from colorization_program.src.toolkit.image_processing import write_image, bgr_to_rgb
...
class MainWindow:
    ...
    def _pick_config(self):
        ...
        ConfigPicker(window, self._config_callback)
